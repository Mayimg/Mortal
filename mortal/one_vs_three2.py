...
from .old_model import Brain as OldBrain
from .old_model import DQN as OldDQN
...
def main():
    ...
    if use_akochan:
        ...
        mortal = OldBrain(version=version, conv_channels=conv_channels, num_blocks=num_blocks).eval()
        dqn = OldDQN(version=version).eval()
